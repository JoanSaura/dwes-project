...
// Consulta para obtener las habitaciones actuales
...
<section id="container-form">
    <form class="login-form" id="delete-room-form" action="/student71/dwes/files/querys/rooms/delete_rooms.php" method="POST"> 
        <h3>Delete a Room</h3>
